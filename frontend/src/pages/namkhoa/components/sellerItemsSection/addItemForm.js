...
export default function AddItemFormControl({ closeModal, categories, items, setItems }) {
  ...
  const [itemName, setItemName] = React.useState("Default Name");
  const [itemCategory, setItemCategory] = React.useState(1);
  const [itemCondition, setItemCondition] = React.useState(4);
  const [itemDescription, setItemDescription] = React.useState("Default Description");
